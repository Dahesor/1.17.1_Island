...
execute if entity @s[nbt={SelectedItem:{tag:{skill:{id:6s,trigger:"to_offhand"}}}}] unless score @s field.c.skill matches 1.. at @s run function operation:skill/initiative/silver_snow/main
